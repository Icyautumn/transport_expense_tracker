            ...
            .then(
              (task) => task.ref.getDownloadURL().then(
                (lessonImage) {
                  ...
                  fsService.editExpense(id, dateCreated, lessonType, studentEmail, lessonImage, lessonDetail);
                  Navigator.of(context).pop();
                },
              ),
            );
      } else {
        fsService.editExpense(id, dateCreated, lessonType, studentEmail,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () => saveForm(selectedLessonDetail.id, context,
                  selectedLessonDetail.lessonImages!, selectedLessonDetail.dateCreated),
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text(dateCreated == null? "Picked date: " +
                          DateFormat('dd/MM/yyyy').format(selectedLessonDetail.dateCreated!) :
                          "Picked date: " +
